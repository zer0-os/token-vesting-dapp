...
const GrantVestingTokens: React.FC<GrantVestingTokensProps> = ({ 
	...
	return (
		<form className={`${styles.Container} blur border-pink-glow border-rounded`}>
			<h1 className="glow-text-white"
				style={{
					marginBottom: '56px'
				}}>Grant Vesting Tokens</h1>
			...
			<section>
				<h2 className="glow-text-blue">Ethereum vesting contract address you wish to grant from:</h2>
